export const idlFactory = ({ IDL }) => {
  ...
  const Result_7 = IDL.Variant({ 'ok' : PoolData, 'err' : Error });
  ...
  const Result_11 = IDL.Variant({ 'ok' : CycleInfo, 'err' : Error });
  ...
  const Result_8 = IDL.Variant({ 'ok' : IDL.Vec(Passcode), 'err' : Error });
  ...
  const Result_3 = IDL.Variant({ 'ok' : IDL.Vec(PoolData), 'err' : Error });
  ...
  const SwapFactory = IDL.Service({
    ...
    'createPool' : IDL.Func([CreatePoolArgs], [Result_7], []),
    'deletePasscode' : IDL.Func([IDL.Principal, Passcode], [Result_1], []),
    'getCurrentUpgradeTask' : IDL.Func([], [Result_12], ['query']),
    'getCycleInfo' : IDL.Func([], [Result_11], []),
    'getGovernanceCid' : IDL.Func([], [Result_10], ['query']),
    'getInitArgs' : IDL.Func([], [Result_9], ['query']),
    ...
    'getPendingUpgradePoolList' : IDL.Func([], [Result_6], ['query']),
    'getPool' : IDL.Func([GetPoolArgs], [Result_7], ['query']),
    'getPoolInstallers' : IDL.Func([], [IDL.Vec(PoolInstaller)], ['query']),
    'getPoolUpgradeTaskHis' : IDL.Func([IDL.Principal], [Result_6], ['query']),
    'getPoolUpgradeTaskHisList' : IDL.Func([], [Result_5], ['query']),
    'getPools' : IDL.Func([], [Result_3], ['query']),
    'getPrincipalPasscodes' : IDL.Func([], [Result_4], ['query']),
    'getRemovedPools' : IDL.Func([], [Result_3], ['query']),
    'getUpgradeFailedPoolList' : IDL.Func([], [Result_2], ['query']),
    ...
    'removePoolErrorTransferLog' : IDL.Func(
